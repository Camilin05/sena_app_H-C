...
class InstructorForm(forms.Form):
    ...
    email = forms.EmailField(required=False, label="Correo Electrónico", help_text="Ingrese el correo electrónico del instructor.")
    ...
    fecha_creacion = forms.DateField(label="Fecha de Registro", help_text="Ingrese la fecha de registro del instructor.")
